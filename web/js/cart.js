/**
 * [Data Flow Summary]
 * 1. 서버(API)로부터 장바구니 데이터를 받아와 'cartItems' 배열에 저장합니다.
 * 2. renderCartList()가 호출되어 HTML 요소를 동적으로 생성하고, 각 상품 ID를 dataset에 심습니다.
 * 3. 사용자가 수량/삭제/주문을 클릭하면 dataset에서 ID를 추출하여 다시 서버(API)로 요청을 보냅니다.
 * 4. 주문 시에는 선택된 정보를 localStorage에 임시 저장하여 'order.html'로 전달합니다.
 */
